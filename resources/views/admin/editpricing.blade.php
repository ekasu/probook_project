                    ...
                    <div class="contact-text py-5  fadeIn" data-wow-delay="0.5s">
                        <div class="p-lg-5 ps-lg-0">
                            ...
                            <div class="card-header rounded mb-1">
                                <h3 class="text-primary">Update Package</h3>
                            </div>
                            <div class="card-body rounded">
                                <form method="POST" action="{{ route('updatepricing', $pricing) }}">
                                    @csrf
                                    <div class="row g-3">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="form-floating">
                                                ...
                                                <div class="">
                                                    ...
                                                    <textarea class="form-control" name="description" id="" value='{{ $pricing->description }}' rows="3">{{ $pricing->description }}</textarea>
                                                </div>
