                    ...
                    <div class="contact-text py-5  fadeIn" data-wow-delay="0.5s">
                        <div class="p-lg-5 ps-lg-0">
                            ...
                            <div class="card-header rounded mb-1">
                                <h3 class="text-primary">Add Footer Information</h3>
                            </div>
                            <div class="card-body rounded">
                                <form method="POST" action="{{ route('addfooter') }}">
                                    @csrf
                                    <div class="row g-3">
                        ...
                        <div class="card-footer rounded  text-muted">
                            <div class="row">
                                <div class="col-md-6 col-lg-6 col-sm-12">
                                    <button name="add-footer" class="btn btn-primary rounded py-2 px-3" type="submit">Add
                                        Footer Info</button>
                                </div>
                                <div class="col-md-6 col-lg-6 col-sm-12">
