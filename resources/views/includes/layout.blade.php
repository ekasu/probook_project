...
<body>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="index.html" class="logo d-flex align-items-center">
                <span class="d-none d-lg-block">Single Page APP</span>
            </a>
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#tables-nav" data-bs-toggle="collapse"
                    href="{{ route('pricing') }}">
                    <i class="bi bi-layout-text-window-reverse"></i><span>Pricing</span><i
                        class="bi bi-chevron-down ms-auto"></i>
                </a>
                <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="{{ route('pricing') }}">
                            <i class="bi bi-circle"></i><span>Manage Pricing</span>
                        </a>
                    </li>
                    {{-- <li>
                        <a href="tables-data.html">
                            <i class="bi bi-circle"></i><span>Exclusive</span>
                        </a>
                    </li>
                    <li>
                        <a href="forms-validation.html">
                            <i class="bi bi-circle"></i><span>Premium </span>
                        </a>
                    </li> --}}
                </ul>
            </li><!-- End Tables Nav -->
    ...
    <footer id="footer" class="footer">
        <div class="copyright">
            &copy; Copyright <strong><span>E Kasu</span></strong>. All Rights Reserved
        </div>
        <div class="credits">

            Designed by <a href="https://bootstrapmade.com/">E-Kasu</a>
        </div>
    </footer><!-- End Footer -->
